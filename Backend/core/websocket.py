...
class WebSocketManager:
    ...
    async def giveScore(self, room_id: str, user_id: int,  data_userId: int, time: int, noPlayers: int, typess:bool, db: any):
    ...
    async def message(self, data: str, websocket: WebSocket, user_id: int, room_id: str, msg_type: int, db:any):
        ...
        elif msg_type == ChatMessageTypes.CLEAR_CANVAS.value:
            if data == "yes":
                self.AIChoosenWord = ""
                self.AIGuessedWords = []
                self.mainStroke = []
